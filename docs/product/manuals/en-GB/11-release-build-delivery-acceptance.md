...
- If code, model, runtime, screenshots or executable behaviour changes, create a new candidate such as `rc.2`, recapture affected evidence and repeat external verification.
