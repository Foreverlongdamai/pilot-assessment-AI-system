...
scope = "说明如何构建、在仓库外验证并交付 Windows x64 v0.1.0-rc.1，同时不提前宣称最终用户验收。"
...
- self-contained `PilotAssessment.Desktop.exe` 与 private .NET/Windows App SDK files；
...
6. 创建 annotated `v0.1.0-rc.1` tag，并证明它 peel 到 `HEAD`。
