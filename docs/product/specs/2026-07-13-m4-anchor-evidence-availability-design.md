...
| 实现状态 | 18/18 已设计，0/18 production plugins 已实现；原 M4 实施计划已被轻量修订取代；replacement Task 0–11 已完成，canonical identity、trusted registry/implementation closure、segment-aware temporal primitives 与 transactional artifact sink 已落地，下一步为 Task 12 central scoring；M4 尚未 engineering verified |
