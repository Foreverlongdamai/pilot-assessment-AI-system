...
| 实现状态 | 18/18 已设计，0/18 production plugins 已实现；原 M4 实施计划已被轻量修订取代；replacement Task 0–12 已完成，canonical identity、trusted registry/implementation closure、segment-aware temporal primitives、transactional artifact sink 与 central scorer 已落地，下一步为 Task 13 evaluator/M4-B stage gate；M4 尚未 engineering verified |
