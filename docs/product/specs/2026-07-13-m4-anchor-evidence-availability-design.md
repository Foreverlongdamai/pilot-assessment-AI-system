...
| 实现状态 | 18/18 已设计，0/18 production plugins 已实现；原 M4 实施计划已被轻量修订取代；replacement Task 0–10 已完成，canonical identity、trusted registry/implementation closure 与 segment-aware temporal primitives 已落地，下一步为 Task 11 transactional artifact publication；M4 尚未 engineering verified |
