...
| 实现状态 | Replacement Task 0–2 已分别由 `bc544bf`、`f56365c`、`928e9a4` 完成，下一步为 Task 3；18/18 specified、0/18 production plugins implemented；M4 尚未 engineering verified |
