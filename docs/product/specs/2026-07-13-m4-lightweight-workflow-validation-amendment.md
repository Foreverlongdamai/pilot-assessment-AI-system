...
| 实现状态 | Replacement Task 0–20 与 M4-C stage gate 已完成；O1–O7 capability 与 `movement-events-v1` provider 均为 `available`，下一步为 Task 21 O8；18/18 specified、7/18 production plugins implemented；M4 整体尚未 engineering verified |
