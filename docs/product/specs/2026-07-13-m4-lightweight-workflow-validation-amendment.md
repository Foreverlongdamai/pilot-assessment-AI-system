...
| 实现状态 | Replacement Task 0–17 已完成；O1/O2/O3/O4 capability 均为 `available`，下一步为 Task 18 O5；18/18 specified、4/18 production plugins implemented；M4-C 与 M4 整体尚未 engineering verified |
