...
| 实现状态 | Replacement Task 0–21 已完成；M4-C stage gate 已关闭、M4-D 已开始；O1–O8 capability 与 `movement-events-v1` provider 均为 `available`，下一步为 Task 22 O9；18/18 specified、8/18 production plugins implemented；M4 整体尚未 engineering verified |
