...
| 实现状态 | Replacement Task 0–16 已完成；O1/O2/O3 capability 均为 `available`，下一步为 Task 17 O4；18/18 specified、3/18 production plugins implemented；M4-C 与 M4 整体尚未 engineering verified |
