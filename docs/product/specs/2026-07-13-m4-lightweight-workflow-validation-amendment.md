...
| 实现状态 | Replacement Task 0–18 已完成；O1/O2/O3/O4/O5 capability 与 `movement-events-v1` provider 均为 `available`，下一步为 Task 19 O6；18/18 specified、5/18 production plugins implemented；M4-C 与 M4 整体尚未 engineering verified |
