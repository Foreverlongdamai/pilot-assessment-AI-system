...
| 实现状态 | 已由提交 `e054620` 完成；后续 replacement Task 4–22 亦已完成，M4-C 已关闭、M4-D 已开始，当前下一步为 Task 23 O10；18/18 specified、9/18 production plugins implemented，这不代表 M4 整体完成 |
