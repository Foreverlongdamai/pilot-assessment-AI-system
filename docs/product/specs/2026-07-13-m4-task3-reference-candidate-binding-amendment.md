...
| 实现状态 | 已由提交 `e054620` 完成；后续 replacement Task 4–24 亦已完成，M4-C 已关闭、M4-D 正在执行，当前下一步为 Task 25 O12；18/18 specified、11/18 production plugins implemented，这不代表 M4 整体完成 |
