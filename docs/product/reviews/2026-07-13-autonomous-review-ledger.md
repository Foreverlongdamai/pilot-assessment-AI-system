...
| Current status | M1–M3 and M4R engineering verified; legacy M4 Task 0–28 complete; 15 legacy/reference plugins and three providers preserved; M5–M7 not implemented; `formal_run_authorized=false`. |
