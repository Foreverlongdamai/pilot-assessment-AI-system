# Known limitations — v0.1.0-rc.4

- User acceptance is `pending`; RC.4 must not be represented as the accepted final `v0.1.0`.
- RC.1, RC.2 and RC.3 remain immutable `changes-required` candidates; RC.4 is a new tag and package.
