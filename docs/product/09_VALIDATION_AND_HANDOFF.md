...
| 当前软件状态 | in_progress（M1/M2/M3、M4R 与 M5 engineering verified；M6 runtime persistence/sidecar、M7 WinUI 与 M8 packaging 尚未完成，`formal_run_authorized=false`） |
