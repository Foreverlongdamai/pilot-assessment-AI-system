...
|---|---|
| 设计版本 | v0.1 |
| 当前软件状态 | in_progress（M1/M2/M3 已 engineering verified；M4 replacement Task 0 已由 `bc544bf` 完成，Task 1 尚未开始；18/18 已设计、0/18 production plugins 已实现；完整 Core alpha 与 Gate B 尚未完成） |
