...
|---|---|
| 设计版本 | v0.1 |
| 当前软件状态 | in_progress（M1/M2/M3 已 engineering verified；M4 为 18/18 已设计、0/18 实现；轻量验证修订、D-026/D-027 与 replacement plan 已接受，原计划已被取代；Task 0 已获授权但尚未开始；完整 Core alpha 与 Gate B 尚未完成） |
