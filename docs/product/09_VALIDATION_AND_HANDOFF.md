...
|---|---|
| 设计版本 | v0.1 |
| 当前软件状态 | in_progress（M1/M2/M3 后端里程碑已 engineering verified；M4 完整书面规格与实施计划均已批准、已授权从 Task 0 开始、18/18 已设计、0/18 实现；完整 Core alpha 与 Gate B 尚未完成） |
