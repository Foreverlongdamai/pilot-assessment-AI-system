...
| 基线日期 | 2026-07-21 |
| 产品阶段 | M1/M2/M3、M4R、M5、M6、M7、M8A 与 **M8B engineering gate 已通过**。**M7 用户手工验收仍未完成，并可能继续返修；D-055 尚待实施；M8C–M8E 未完成。** starter/synthetic `formal_run_authorized=false` |
