...
| 基线日期 | 2026-07-17 |
| 产品阶段 | M1/M2/M3、M4R、M5、M6 与 M7A Current Model Runtime 已工程验证；M7B WinUI 尚未实现；M8 packaging 尚未设计；starter/synthetic `formal_run_authorized=false` |
