...
| 25 | [M4 Task 7 Catalog and Resource Identity 修订](specs/2026-07-13-m4-task7-catalog-resource-identity-amendment.md) | 开发、算法、审查者 | 已按授权默认批准：exact-18 catalog、artifact/provider descriptors、24 个 canonical parameter schemas、scorer/O6/O13 profile closure |
