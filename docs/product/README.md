...
| 基线日期 | 2026-07-13 |
| 产品阶段 | M1/M2/M3 后端里程碑已工程验证；M4 为 18/18 已设计、0/18 已实现，实施计划已形成并等待用户批准；完整产品仍为 in_progress，Gate B 尚未通过 |
...
| 21 | [M4 实施计划](plans/2026-07-13-m4-anchor-evidence-availability-implementation-plan.md) | 开发、算法、审查者 | 待批准：Task 0–36 的 fixture-first、合同、引擎、逐锚点 TDD、E2E、确定性与隔离 wheel 步骤；当前尚未开始代码实现 |
