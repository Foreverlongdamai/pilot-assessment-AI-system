...
| 基线日期 | 2026-07-16 |
| 产品阶段 | M1/M2/M3 与 M4R Evidence Computation Foundation 已工程验证；M5 正在按轻量 inline 计划实施，Task 1–2 generic identity、public contracts 与 JSON Schema 已完成，Task 3–12 尚未完成；M6 runtime persistence/sidecar、M7 WinUI 与 M8 packaging 尚未实现；`formal_run_authorized=false` |
