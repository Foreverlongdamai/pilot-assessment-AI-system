...
| 基线日期 | 2026-07-16 |
| 产品阶段 | M1/M2/M3、M4R Evidence Computation Foundation 与 M5 Shared Model Library/Bayesian Workspace 已工程验证；M6 runtime persistence/sidecar 是下一里程碑，M7 WinUI 与 M8 packaging 尚未实现；`formal_run_authorized=false` |
