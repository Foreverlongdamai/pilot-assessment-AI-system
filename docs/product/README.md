...
| 基线日期 | 2026-07-17 |
| 产品阶段 | M1/M2/M3、M4R、M5、M6 与 M7A Current Model Runtime 已工程验证；M7B Task 1–5 已完成 WinUI scaffold、强类型合同层、受监督 sidecar、真实应用 shell 与受管 project/session 工作区，其余交互仍在实施；M8 packaging 尚未设计；starter/synthetic `formal_run_authorized=false` |
