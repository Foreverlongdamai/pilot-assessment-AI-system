...
| 下一里程碑 | M6 persistence/runtime protocol：正式规格已批准，下一步按 inline 实施计划完成 durable project/session/model/run repository、managed artifacts、JSON-RPC sidecar 与 run lifecycle；不直接跳到 M7 WinUI |
