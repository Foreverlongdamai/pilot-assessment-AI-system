# Implementation Status — RC.3 Acceptance Corrections In Verification
...
| 下一里程碑 | 完成 RC.3 文档、clean tag、发布包与仓库外验证，再交由用户独立验收；不移动 RC.1/RC.2 标签 |
| 软件状态 | `in_progress`（M1–M8E engineering history preserved；RC.1/RC.2 user acceptance=`changes-required`；D-084–D-087 RC.3 修订已通过聚焦代码门，完整候选门待关闭；starter/synthetic `formal_run_authorized=false`） |
...
RC.3 的 clean annotated tag、ZIP 和仓库外 restricted-PATH verification 尚未在本段状态时点完成；因此不得声称 RC.3 engineering candidate ready。
...
M8A–M8E、D-055、M8C-1 与 RC.2 root-layout correction 已完成工程实现和候选自动验证。用户对 RC.2 的下一轮验收产生 D-084–D-087；当前下一动作是完成 RC.3 candidate gate。阶段结果为：
...
7. RC.3：Assessment 技术执行、图标、全局删除与按住拖动代码/聚焦回归已完成；候选文档、截图、tag、ZIP 与外部 gate 正在执行。
...
- [RC.3 Run and Model Studio Amendment](specs/2026-07-21-rc3-run-and-model-studio-acceptance-amendment.md)、[Plan](plans/2026-07-21-rc3-run-and-model-studio-implementation-plan.md) 与 [RC.2 User Acceptance Result](reviews/2026-07-21-v0.1.0-rc.2-user-acceptance-result.md)（当前 Assessment、图标、删除与拖动修订）
