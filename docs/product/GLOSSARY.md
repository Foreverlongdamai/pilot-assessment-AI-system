...
| Release candidate | 带明确 prerelease 标签、源码提交、system identity、文档、checksum、SBOM、限制和验证证据的可验收交付物。candidate 不等于最终版本；`v0.1.0-rc.1`、`v0.1.0-rc.2` 与 `v0.1.0-rc.3` 均已被用户标记为 `changes-required`，不得改写，当前修订进入 `v0.1.0-rc.4`。 |
