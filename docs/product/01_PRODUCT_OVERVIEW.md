...
**文档状态：** 产品 v0 设计基线（M4 完整书面规格、轻量工作流验证修订与 replacement plan 均已于 2026-07-13 获用户批准；D-026/D-027 已接受；原实施计划已被取代；Task 0 已由 `bc544bf` 完成，Task 1 尚未开始；18/18 anchors 已设计，0/18 production plugins 已实现）
**日期：** 2026-07-13
...
- [M4 Anchor Calculation and Evidence Availability Replacement Implementation Plan](./plans/2026-07-13-m4-anchor-evidence-availability-replacement-implementation-plan.md)（已于 2026-07-13 批准；Task 0 已完成，Task 1 尚未开始）
