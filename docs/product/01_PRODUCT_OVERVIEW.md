...
**文档状态：** 产品 v0 设计基线（M4 完整书面规格、轻量工作流验证修订、Task 3 Reference Candidate Binding 修订与 replacement plan 均已获批准；D-026–D-028 已接受；原实施计划已被取代；Task 0–4 已分别由 `bc544bf`、`f56365c`、`928e9a4`、`e054620`、`1528d09` 完成，catalog/plan/request contracts 已实现，下一步为 Task 5 measurement/artifact/inventory/report contracts；18/18 anchors 已设计，0/18 production plugins 已实现；M4 尚未 engineering verified）
**日期：** 2026-07-13
...
- [M4 Anchor Calculation and Evidence Availability Replacement Implementation Plan](./plans/2026-07-13-m4-anchor-evidence-availability-replacement-implementation-plan.md)（已于 2026-07-13 批准并修订；Task 0–4 已完成，下一步为 Task 5 measurement/artifact/inventory/report contracts）
