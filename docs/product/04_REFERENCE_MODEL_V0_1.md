...
| Anchor 实现状态 | 18/18 已设计，0/18 production plugins 已实现；原 M4 实施计划已被取代，replacement plan 已于 2026-07-13 批准；Task 0–2 已完成，下一步为 Task 3 |
...
当前只可声称 **18/18 anchors specified，0/18 production plugins implemented**。Reference M4 完成至少需要：
...
M4 书面规格、轻量工作流验证修订与 [replacement plan](./plans/2026-07-13-m4-anchor-evidence-availability-replacement-implementation-plan.md) 均已批准，D-026/D-027 已接受；原实施计划已被取代且不再提供执行授权。Replacement Task 0–2 已分别由 `bc544bf`、`f56365c`、`928e9a4` 完成，下一步为 Task 3；在相应 production-plugin 完成门通过前仍保持 0/18 implemented。
