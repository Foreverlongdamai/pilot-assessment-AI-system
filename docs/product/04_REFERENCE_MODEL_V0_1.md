...
| Anchor 实现状态 | 18/18 已设计，12/18 production plugins 已实现；原 M4 实施计划已被取代，replacement plan 与 Task 3/7/8 amendments、D-028–D-030 已批准；Task 0–25 已完成，M4-C/M4-D stage gates 已关闭，O1–O12 capability 均为 `available`，共享 `events` primitive 与 `movement-events-v1` provider 已实现，下一步为 Task 26 H1 |
...
当前只可声称 **18/18 anchors specified，12/18 production plugins implemented，M4-C/M4-D software-verified，M4-E not started**。Reference M4 完成至少需要：
