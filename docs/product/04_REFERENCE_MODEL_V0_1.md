...
| Anchor 实现状态 | 18/18 已设计，3/18 production plugins 已实现；原 M4 实施计划已被取代，replacement plan 与 Task 3/7/8 amendments、D-028–D-030 已批准；Task 0–16 已完成，O1/O2/O3 capability 均为 `available`，下一步为 Task 17 O4 |
...
当前只可声称 **18/18 anchors specified，3/18 production plugins implemented**。Reference M4 完成至少需要：
