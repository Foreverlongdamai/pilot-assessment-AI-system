...
| Anchor 实现状态 | 18/18 已设计，13/18 production plugins 已实现；原 M4 实施计划已被取代，replacement plan 与 Task 3/7/8 amendments、D-028–D-030 已批准；Task 0–26 已完成，M4-C/M4-D stage gates 已关闭、M4-E 进行中，O1–O12/H1 capability 均为 `available`，共享 `events` primitive 与 `movement-events-v1`/`gaze-aoi-intervals-v1` providers 已实现，下一步为 Task 27 H2 |
...
当前只可声称 **18/18 anchors specified，13/18 production plugins implemented，M4-C/M4-D software-verified，M4-E in progress**。Reference M4 完成至少需要：
