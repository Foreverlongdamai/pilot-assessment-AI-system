...
- [ ] **Step 0: Prove the provisional heavy files are disposable and preserve the runtime lock**
...
- [ ] **Step 1: Write the lightweight RED contract before any production plugin exists**
...
- [ ] **Step 2: Lock and audit the numeric/JCS dependencies**
...
- [ ] **Step 3: Implement the input-only 10-second builder**
...
- [ ] **Step 4: Freeze an independent exact-18 expected vector without answer echo**
...
- [ ] **Step 5: Prove the lightweight gate is GREEN and bounded**
...
- [ ] **Step 6: Commit only the lightweight prerequisite**
