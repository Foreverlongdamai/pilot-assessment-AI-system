...
原始 2026-07-10 的结论只适用于当时产品设计闭环。2026-07-13 的 M4 amendment 已经按独立复审修订其 P1 歧义，但在用户批准完整书面规格前，只能作为 implementation-plan candidate；默认阈值、拓扑和 CPT 仍等待专家与数据校准。
