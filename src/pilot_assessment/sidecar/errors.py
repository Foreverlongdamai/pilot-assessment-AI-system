...
class DomainErrorCode(StrEnum):
    ...
    SYSTEM_MODEL_LOCKED = "SYSTEM_MODEL_LOCKED"
    SYSTEM_MODEL_UNAVAILABLE = "SYSTEM_MODEL_UNAVAILABLE"
    TRANSACTION_REUSE_MISMATCH = "TRANSACTION_REUSE_MISMATCH"
    SESSION_IMPORT_INVALID = "SESSION_IMPORT_INVALID"
    SESSION_SOURCE_UNRECOGNIZED = "SESSION_SOURCE_UNRECOGNIZED"
    RAW_PROFILE_AMBIGUOUS = "RAW_PROFILE_AMBIGUOUS"
    RAW_PROFILE_UNSUPPORTED = "RAW_PROFILE_UNSUPPORTED"
    RAW_REQUIRED_INPUT_UNRESOLVED = "RAW_REQUIRED_INPUT_UNRESOLVED"
    RAW_ANNOTATION_MAPPING_INVALID = "RAW_ANNOTATION_MAPPING_INVALID"
    RAW_SOURCE_CHANGED = "RAW_SOURCE_CHANGED"
    RAW_MATERIALIZATION_INVALID = "RAW_MATERIALIZATION_INVALID"
    RAW_RESERVED_PATH_COLLISION = "RAW_RESERVED_PATH_COLLISION"
    RAW_SOURCE_PATH_INVALID = "RAW_SOURCE_PATH_INVALID"
    RAW_SOURCE_LIMIT_EXCEEDED = "RAW_SOURCE_LIMIT_EXCEEDED"
    ...
    MODEL_EDIT_SESSION_CONFLICT = "MODEL_EDIT_SESSION_CONFLICT"
    MODEL_EDIT_SESSION_HISTORY_BOUNDARY = "MODEL_EDIT_SESSION_HISTORY_BOUNDARY"
    MODEL_EDIT_SESSION_DIRTY = "MODEL_EDIT_SESSION_DIRTY"
...
_DOMAIN_RPC_CODES = {
    ...
    DomainErrorCode.SYSTEM_MODEL_LOCKED: -32001,
    DomainErrorCode.SYSTEM_MODEL_UNAVAILABLE: -32001,
    DomainErrorCode.TRANSACTION_REUSE_MISMATCH: -32002,
    DomainErrorCode.SESSION_IMPORT_INVALID: -32003,
    DomainErrorCode.SESSION_SOURCE_UNRECOGNIZED: -32003,
    DomainErrorCode.RAW_PROFILE_AMBIGUOUS: -32003,
    DomainErrorCode.RAW_PROFILE_UNSUPPORTED: -32003,
    DomainErrorCode.RAW_REQUIRED_INPUT_UNRESOLVED: -32003,
    DomainErrorCode.RAW_ANNOTATION_MAPPING_INVALID: -32003,
    DomainErrorCode.RAW_SOURCE_CHANGED: -32003,
    DomainErrorCode.RAW_MATERIALIZATION_INVALID: -32003,
    DomainErrorCode.RAW_RESERVED_PATH_COLLISION: -32003,
    DomainErrorCode.RAW_SOURCE_PATH_INVALID: -32003,
    DomainErrorCode.RAW_SOURCE_LIMIT_EXCEEDED: -32003,
    ...
    DomainErrorCode.MODEL_EDIT_SESSION_CONFLICT: -32020,
    DomainErrorCode.MODEL_EDIT_SESSION_HISTORY_BOUNDARY: -32020,
    DomainErrorCode.MODEL_EDIT_SESSION_DIRTY: -32022,
