...
| M5 Shared Model Library and Bayesian Workspace | 实施中；Task 1–3 已完成：generic identity、public model/BN/scheme contracts、16 类双目录 JSON Schema，以及 typed source provenance/M4R migration preflight；Task 4 global component library 为下一步 |
