...
| M5 Shared Model Library and Bayesian Workspace | 实施中；Task 1–6 已完成：generic identity、public contracts/Schema、typed source/M4R preflight、global immutable component library、exact-pinned validation，以及可自动保存/撤销/重做并原子发布的 scheme draft workspace；Task 7 BN/CPT validation/materialization/migration 为下一步 |
