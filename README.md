...
| M7 WinUI Expert Designer | M7A 后端已工程验证；M7B Task 1–5 已完成正式 WinUI scaffold、强类型合同层、受监督 sidecar、真实应用 shell，以及受管 project/session 工作区；task scheme、模型画布与完整专家交互仍在实施 |
