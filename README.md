...
| M7 WinUI Expert Designer | M7A 后端已工程验证；M7B Task 1–8 已完成正式 WinUI scaffold、强类型合同层、受监督 sidecar、受管 project/session、canonical task-scheme、global active/dim 模型图，以及节点新建、激活/级联停用、复制/粘贴、拖拽布局和 typed edge 编辑；Task 9 起继续实现多独立节点浮窗与完整编辑器 |
